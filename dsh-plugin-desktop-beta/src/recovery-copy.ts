...
const COPY: Record<DesktopLocale, DesktopRecoveryCopy> = {
  en: {
    ...
    dataManagementBody: 'The DSH data directory currently used by this Desktop app.',
    ...
    dataDirectoryPlaceholder: 'Enter the absolute path of an existing folder',
  ...
  zh: {
    ...
    dataManagement: '数据管理',
    dataManagementBody: '当前桌面端正在使用的 DSH 数据目录。',
    ...
    dataDirectoryPlaceholder: '输入一个已存在文件夹的绝对路径',
